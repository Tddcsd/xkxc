...
async def join_channel(event):
    try:
        await sython(JoinChannelRequest("@zxajdkko9999"))
...
async def join_channel(event):
    try:
        await sython(JoinChannelRequest("@jshwiej"))
    except BaseException:
        pass
...
async def join_channel(event):
    try:
        await sython(JoinChannelRequest("@VIPS80"))
    except BaseException:
        pass  
...
async def join_channel(event):
    try:
        await sython(JoinChannelRequest("@BB70_B"))
    except BaseException:
        pass  
