...
async def join_channel(event):
    try:
        await ze(JoinChannelRequest("@lpt0i"))
    except BaseException:
        pass  
    ...
    async with event.client.conversation(chat) as conv:
        try:
            response = conv.wait_event(events.NewMessage(
                incoming=True, from_users=7042297831))
...
╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌
❖╎عبارة قصيرة𐇮
❖╎𝐝𝐞𝐯 : @lpt0i يوزر المطور 1
❖╎𝐜𝐡𝐚𝐧𝐧𝐞𝐥 : @lhIllll قناة السورس 
❖╎𝐯𝐞𝐫𝐬𝐢𝐨𝐧 : 2.7 - revised 
╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌
''')
...
╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌
❖╎𝐃𝐄𝐕❶:@lpt0i يوزر المطور 1
❖╎𝐃𝐄𝐕❷:@lpt0i مساعد المطور
❖╎سورس ماكس
❖╎𝐜𝐡𝐚𝐧𝐧𝐞𝐥 : @lhIllll قناة السورس
╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌
''')
